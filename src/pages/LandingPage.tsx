...
const pricingPlans = [
  {
    ...
    description: "Perfect for exploring Beebizy",
    features: [
      "5 AI planning messages",
      "Budget overview",
      "1 vendor recommendation",
      "Basic checklist preview",
    ],
    cta: "Start free",
    href: "/signup",
  },
  {
    ...
    price: "$49",
    period: "/mo",
    caption: "Plan 1 or more events per year",
    description: "For teams planning annual events",
    features: [
      "Unlimited AI planning chat",
      "AI-generated mood board (4 images)",
      "Full budget breakdown",
      "All 5 vendor recommendations",
      "Auto-generated checklist",
      "Run of show & floor plan",
      "Export to PDF",
    ],
    cta: "Get Business",
    href: "/signup",
...
function PricingSection() {
  return (
    <div className="ai-pricing-inner">
      <div className="ai-pricing-intro">
        <p className="ai-pricing-eyebrow">AI Planner</p>
        <h2 className="ai-pricing-title">
          Start planning for free.
          <br />
          Scale when you're ready.
        </h2>
        <p className="ai-pricing-subtitle">
          Bee, our AI event planner, is available at every stage - from your first
          <br className="ai-pricing-desktop-break" /> event to your hundredth.
        </p>
      </div>

      <div className="ai-pricing-grid">
        {pricingPlans.map((plan) => (
          <article className={`ai-pricing-card ${plan.key}`} key={plan.key}>
            {plan.popular ? <div className="ai-pricing-popular">Most popular</div> : null}
            <p className="ai-pricing-plan-name">{plan.name}</p>
            <div className="ai-pricing-price">
              {plan.price}
              {plan.period ? <span className="ai-pricing-price-period">{plan.period}</span> : null}
            </div>
            <p className="ai-pricing-caption">{plan.caption}</p>
            <p className="ai-pricing-description">{plan.description}</p>
            <ul className="ai-pricing-features">
              {plan.features.map((feature) => (
                <li className="ai-pricing-feature" key={feature}>
                  <CircleCheck aria-hidden="true" />
                  <span>{feature}</span>
                </li>
              ))}
            </ul>
            <a className="ai-pricing-cta" href={plan.href}>
              {plan.cta}
...
export function LandingPage() {
  useEffect(() => {
    ...
    const styles = ["/original.css", "/mobile.css", "/pricing.css"].map((href) => {
    ...
    const pricingHost = document.createElement("section");
    pricingHost.id = "pricing";
    pricingHost.className = "ai-pricing-section";
