    ...
    <div className="grid min-h-dvh place-items-center bg-background px-5 py-12">
      <div className="w-full max-w-lg space-y-7 text-center">
        ...
        <div className="rounded-2xl border border-card-border bg-card p-8 shadow-sm">
          ...
          <h1 className="mt-5 text-3xl font-extrabold tracking-tight">Your subscription is being activated</h1>
          <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
            Stripe has completed checkout. Beebizy will unlock the workspace as soon as the verified payment update arrives.
          </p>
